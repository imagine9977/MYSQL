...
try {
	...
	while (rs.next()) {
		Book book = new Book(rs.getInt("bookid"), rs.getString("bookkind"), rs.getString("booktitle"),
		rs.getInt("bookprice"), rs.getInt("bookcount"), rs.getString("author"), rs.getString("pubcom"),
